...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "antor") || (event.body.toLowerCase() == "antor bai") || (event.body.toLowerCase() == "@Ullash ッ") || (event.body.toLowerCase() == "উল্লাস")) {
  ...
  if ((event.body.toLowerCase() == "Asraf") || (event.body.toLowerCase() == "arohi")) {
  ...
  if ((event.body.toLowerCase() == "@Ridu ") || (event.body.toLowerCase() == "সিয়াম")) {
   ...
   if ((event.body.toLowerCase() == "ghumabo") || (event.body.toLowerCase() == "tor nanire xudi")) {
